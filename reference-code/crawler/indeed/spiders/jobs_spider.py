...
class IndeedJobSpider(scrapy.Spider):
    ...
    # FIXME: extract to utility, used in both versions of the indeed scraper
    ...
    # FIXME:  - extract to utility, used in both versions of the indeed scraper
    #        - think of how to expose the setting of keyword_list & location_list
    ...
    def parse_search_results(self, response):
        ...
        # Indeed stores the page data in a json blob that is set in a script.
