    ...
    <div>
      <div>
        ...
        <main className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          <div className="hidden border-b pb-10">
            <h1 className="text-4xl font-bold font-heading tracking-tight">New Arrivals</h1>
          ...
          <div className="pt-12 lg:grid lg:grid-cols-3 lg:gap-x-8 xl:grid-cols-4">
            <aside>
              ...
              >
                ...
                <PlusIcon className="ml-1 h-5 w-5 flex-shrink-0 text-muted-foreground" aria-hidden="true"/>
              </button>

              <div className="hidden lg:block">
                <form className="space-y-10 divide-y divide-border">
                          ...
                          {section.options.map((option, optionIdx) => (
                            <div key={option.value} className="flex items-center">
                              <input
                                ...
                                defaultValue={option.value}
                                type="checkbox"
                                className="h-4 w-4 rounded  text-primary focus:ring-indigo-500"
                              />
            ...
            {/* Product grid */}
            <div className="mt-6 lg:col-span-2 lg:mt-0 xl:col-span-3 bg-white">{/* Your content */}</div>
          </div>
        </main>
      </div>
    </div>
